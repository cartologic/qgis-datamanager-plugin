...
SOURCES = \
	__init__.py \
	data_manager.py data_manager_dockwidget.py

PLUGINNAME = data_manager

PY_FILES = \
	__init__.py \
	data_manager.py data_manager_dockwidget.py

UI_FILES = data_manager_dockwidget_base.ui
...
QGISDIR=C:\Users\geo\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
